...
void Adafruit_INA219::setCalibration_05ohm() {
    // Calibration for 0.05 ohm shunt resistor

  // Calibration calculation
  ina219_calValue = 8192;

  // Set multipliers to convert raw current/power values
  ina219_currentDivider_mA = 10; // 100 uA per bit
  ina219_powerMultiplier_mW = 2; // 2 mW per bit
...
void Adafruit_INA219::setCalibration_01ohm() {
  // For 0.01 ohm shunt resistor

  // Calibration value calculation:
  ina219_calValue = 4096; // same as before due to scaling

  // Set multipliers to convert raw current/power values
  ina219_currentDivider_mA = 1;  // Current LSB = 1mA per bit (1000 / 1000)
  ina219_powerMultiplier_mW = 20; // Power LSB = 20mW per bit (20 * 1mA)
